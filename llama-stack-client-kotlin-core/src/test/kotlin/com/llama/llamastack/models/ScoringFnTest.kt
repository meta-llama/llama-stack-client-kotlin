    ...
    fun createScoringFn() {
        val scoringFn =
            ScoringFn.builder()
                ...
                .metadata(ScoringFn.Metadata.builder().build())
                .providerId("provider_id")
                .providerResourceId("provider_resource_id")
                .returnType(
                    ScoringFn.ReturnType.ofType(
                        ScoringFn.ReturnType.Type.builder()
                            .type(ScoringFn.ReturnType.Type.Type.STRING)
                            .build()
                    )
                )
        ...
        assertThat(scoringFn.metadata()).isEqualTo(ScoringFn.Metadata.builder().build())
