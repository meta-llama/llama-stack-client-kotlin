...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AgentSessionCreateResponse && this.sessionId == other.sessionId && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun hashCode(): Int {
        if (hashCode == 0) {
            hashCode = /* spotless:off */ Objects.hash(sessionId, additionalProperties) /* spotless:on */
        }
        return hashCode
    }
