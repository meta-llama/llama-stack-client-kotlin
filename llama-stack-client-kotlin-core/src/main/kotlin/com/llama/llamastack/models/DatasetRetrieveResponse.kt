...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DatasetRetrieveResponse && identifier == other.identifier && metadata == other.metadata && providerId == other.providerId && providerResourceId == other.providerResourceId && purpose == other.purpose && source == other.source && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DatasetRetrieveResponse{identifier=$identifier, metadata=$metadata, providerId=$providerId, providerResourceId=$providerResourceId, purpose=$purpose, source=$source, type=$type, additionalProperties=$additionalProperties}"
}
