...
constructor(
    ...
    class Builder {
        ...
        fun params(llmAsJudge: Params.LlmAsJudge) = apply { body.params(llmAsJudge) }

        fun params(regexParser: Params.RegexParser) = apply { body.params(regexParser) }

        fun params(basic: Params.Basic) = apply { body.params(basic) }
