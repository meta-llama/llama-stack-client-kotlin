...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is Trace && this.endTime == other.endTime && this.rootSpanId == other.rootSpanId && this.startTime == other.startTime && this.traceId == other.traceId && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun hashCode(): Int {
        if (hashCode == 0) {
            hashCode = /* spotless:off */ Objects.hash(endTime, rootSpanId, startTime, traceId, additionalProperties) /* spotless:on */
        }
        return hashCode
    }
