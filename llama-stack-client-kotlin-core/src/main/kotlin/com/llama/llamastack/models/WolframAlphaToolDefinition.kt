...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WolframAlphaToolDefinition && this.apiKey == other.apiKey && this.inputShields == other.inputShields && this.outputShields == other.outputShields && this.remoteExecution == other.remoteExecution && this.type == other.type && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun hashCode(): Int {
        if (hashCode == 0) {
            hashCode = /* spotless:off */ Objects.hash(apiKey, inputShields, outputShields, remoteExecution, type, additionalProperties) /* spotless:on */
        }
        return hashCode
    }
