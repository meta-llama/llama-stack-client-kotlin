...
private constructor(
    ...
    class Builder {
        ...
        fun addData(vectorMemoryBank: Data.VectorMemoryBank) =
            addData(Data.ofVectorMemoryBank(vectorMemoryBank))

        fun addData(keyValueMemoryBank: Data.KeyValueMemoryBank) =
            addData(Data.ofKeyValueMemoryBank(keyValueMemoryBank))

        fun addData(keywordMemoryBank: Data.KeywordMemoryBank) =
            addData(Data.ofKeywordMemoryBank(keywordMemoryBank))

        fun addData(graphMemoryBank: Data.GraphMemoryBank) =
            addData(Data.ofGraphMemoryBank(graphMemoryBank))
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Data && vectorMemoryBank == other.vectorMemoryBank && keyValueMemoryBank == other.keyValueMemoryBank && keywordMemoryBank == other.keywordMemoryBank && graphMemoryBank == other.graphMemoryBank /* spotless:on */
        }
        ...
        override fun toString(): String =
            when {
                vectorMemoryBank != null -> "Data{vectorMemoryBank=$vectorMemoryBank}"
                keyValueMemoryBank != null -> "Data{keyValueMemoryBank=$keyValueMemoryBank}"
                keywordMemoryBank != null -> "Data{keywordMemoryBank=$keywordMemoryBank}"
                graphMemoryBank != null -> "Data{graphMemoryBank=$graphMemoryBank}"
