...
constructor(
    ...
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is EvalEvaluateRowsBody && this.inputRows == other.inputRows && this.scoringFunctions == other.scoringFunctions && this.taskConfig == other.taskConfig && this.taskId == other.taskId && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun hashCode(): Int {
            if (hashCode == 0) {
                hashCode = /* spotless:off */ Objects.hash(inputRows, scoringFunctions, taskConfig, taskId, additionalProperties) /* spotless:on */
            }
            return hashCode
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EvalEvaluateRowsParams && this.inputRows == other.inputRows && this.scoringFunctions == other.scoringFunctions && this.taskConfig == other.taskConfig && this.taskId == other.taskId && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(inputRows, scoringFunctions, taskConfig, taskId, additionalHeaders, additionalQueryParams, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "EvalEvaluateRowsParams{inputRows=$inputRows, scoringFunctions=$scoringFunctions, taskConfig=$taskConfig, taskId=$taskId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(evalEvaluateRowsParams: EvalEvaluateRowsParams) = apply {
            this.inputRows(evalEvaluateRowsParams.inputRows)
            this.scoringFunctions(evalEvaluateRowsParams.scoringFunctions)
            this.taskConfig = evalEvaluateRowsParams.taskConfig
            this.taskId = evalEvaluateRowsParams.taskId
            additionalHeaders(evalEvaluateRowsParams.additionalHeaders)
            additionalQueryParams(evalEvaluateRowsParams.additionalQueryParams)
            additionalBodyProperties(evalEvaluateRowsParams.additionalBodyProperties)
        }
