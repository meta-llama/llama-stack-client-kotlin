...
constructor(
    ...
    @JsonDeserialize(builder = MemoryBankUnregisterBody.Builder::class)
    @NoAutoDetect
    ...
    internal constructor(
        ...
        class Builder {
            ...
            internal fun from(memoryBankUnregisterBody: MemoryBankUnregisterBody) = apply {
                this.memoryBankId = memoryBankUnregisterBody.memoryBankId
                additionalProperties(memoryBankUnregisterBody.additionalProperties)
            }
            ...
            fun build(): MemoryBankUnregisterBody =
                MemoryBankUnregisterBody(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is MemoryBankUnregisterBody && memoryBankId == other.memoryBankId && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(memoryBankId, additionalProperties) }
        /* spotless:on */
