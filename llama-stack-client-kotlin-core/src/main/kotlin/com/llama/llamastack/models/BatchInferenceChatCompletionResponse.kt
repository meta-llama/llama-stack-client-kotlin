...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchInferenceChatCompletionResponse && this.completionMessageBatch == other.completionMessageBatch && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun hashCode(): Int {
        if (hashCode == 0) {
            hashCode = /* spotless:off */ Objects.hash(completionMessageBatch, additionalProperties) /* spotless:on */
        }
        return hashCode
    }
