...
@JsonDeserialize(builder = BatchChatCompletion.Builder::class)
@NoAutoDetect
class BatchChatCompletion
private constructor(
    ...
    fun validate(): BatchChatCompletion = apply {
        if (!validated) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchChatCompletion &&
    ...
    override fun toString() =
        "BatchChatCompletion{completionMessageBatch=$completionMessageBatch, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(batchChatCompletion: BatchChatCompletion) = apply {
            this.completionMessageBatch = batchChatCompletion.completionMessageBatch
            additionalProperties(batchChatCompletion.additionalProperties)
        }
