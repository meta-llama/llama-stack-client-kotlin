...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Turn &&
            ...
            this.outputAttachments == other.outputAttachments &&
            this.outputMessage == other.outputMessage &&
    ...
    class Builder {
        ...
        fun build(): Turn =
            Turn(
                completedAt,
                inputMessages.map { it.toUnmodifiable() },
                outputAttachments.map { it.toUnmodifiable() },
                outputMessage,
                sessionId,
                startedAt,
                steps.map { it.toUnmodifiable() },
                turnId,
