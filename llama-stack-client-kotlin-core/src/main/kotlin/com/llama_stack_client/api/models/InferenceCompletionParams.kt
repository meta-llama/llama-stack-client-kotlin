...
constructor(
    ...
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is InferenceCompletionBody &&
        ...
        override fun toString() =
            "InferenceCompletionBody{content=$content, model=$model, logprobs=$logprobs, samplingParams=$samplingParams, stream=$stream, additionalProperties=$additionalProperties}"
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InferenceCompletionParams &&
            this.content == other.content &&
            this.model == other.model &&
            this.logprobs == other.logprobs &&
            this.samplingParams == other.samplingParams &&
    ...
    override fun toString() =
        "InferenceCompletionParams{content=$content, model=$model, logprobs=$logprobs, samplingParams=$samplingParams, stream=$stream, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun content(strings: List<String>) = apply { this.content = Content.ofStrings(strings) }
