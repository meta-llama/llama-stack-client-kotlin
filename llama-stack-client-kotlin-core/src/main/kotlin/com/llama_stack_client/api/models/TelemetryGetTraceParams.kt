...
constructor(
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.traceId.let { params.put("trace_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TelemetryGetTraceParams &&
    ...
    override fun toString() =
        "TelemetryGetTraceParams{traceId=$traceId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
