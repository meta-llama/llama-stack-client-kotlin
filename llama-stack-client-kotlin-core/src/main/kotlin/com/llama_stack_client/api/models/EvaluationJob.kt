...
@JsonDeserialize(builder = EvaluationJob.Builder::class)
@NoAutoDetect
class EvaluationJob
private constructor(
    ...
    fun validate(): EvaluationJob = apply {
        if (!validated) {
            jobUuid()
            validated = true
        }
    ...
    override fun toString() =
        "EvaluationJob{jobUuid=$jobUuid, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(evaluationJob: EvaluationJob) = apply {
            this.jobUuid = evaluationJob.jobUuid
            additionalProperties(evaluationJob.additionalProperties)
        }
        ...
        fun build(): EvaluationJob = EvaluationJob(jobUuid, additionalProperties.toUnmodifiable())
    }
}
