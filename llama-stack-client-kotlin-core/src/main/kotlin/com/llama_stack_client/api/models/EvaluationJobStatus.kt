...
@JsonDeserialize(builder = EvaluationJobStatus.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    fun validate(): EvaluationJobStatus = apply {
        if (!validated) {
            jobUuid()
            validated = true
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EvaluationJobStatus &&
    ...
    override fun toString() =
        "EvaluationJobStatus{jobUuid=$jobUuid, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(evaluationJobStatus: EvaluationJobStatus) = apply {
            this.jobUuid = evaluationJobStatus.jobUuid
            additionalProperties(evaluationJobStatus.additionalProperties)
        }
        ...
        fun build(): EvaluationJobStatus =
            EvaluationJobStatus(jobUuid, additionalProperties.toUnmodifiable())
    }
}
