...
constructor(
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.stepId.let { params.put("step_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentStepRetrieveParams &&
    ...
    override fun toString() =
        "AgentStepRetrieveParams{agentId=$agentId, stepId=$stepId, turnId=$turnId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
