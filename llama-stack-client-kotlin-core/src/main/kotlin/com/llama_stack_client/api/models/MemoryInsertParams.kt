...
constructor(
    ...
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is MemoryInsertBody &&
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MemoryInsertParams &&
            this.bankId == other.bankId &&
            this.documents == other.documents &&
            this.ttlSeconds == other.ttlSeconds &&
    ...
    override fun toString() =
        "MemoryInsertParams{bankId=$bankId, documents=$documents, ttlSeconds=$ttlSeconds, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
