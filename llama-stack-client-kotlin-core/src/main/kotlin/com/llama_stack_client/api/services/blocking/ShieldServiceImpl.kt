...
constructor(
    ...
    override fun list(params: ShieldListParams, requestOptions: RequestOptions): ShieldSpec {
        val request =
            HttpRequest.builder()
    ...
    override fun get(params: ShieldGetParams, requestOptions: RequestOptions): ShieldSpec? {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.GET)
