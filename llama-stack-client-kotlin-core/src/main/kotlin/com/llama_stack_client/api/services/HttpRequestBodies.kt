...
import com.llama_stack_client.api.core.MultipartFormValue
import com.llama_stack_client.api.core.http.HttpRequestBody
    ...
    return object : HttpRequestBody {
        ...
        private fun serialize(): ByteArray {
            ...
            try {
                ...
                throw LlamaStackClientException("Error writing request", e)
            }
        }
            ...
            when (part.value) {
                is JsonValue -> {
                    ...
                    try {
                        ...
                        throw LlamaStackClientException("Error serializing value to json", e)
                    }
