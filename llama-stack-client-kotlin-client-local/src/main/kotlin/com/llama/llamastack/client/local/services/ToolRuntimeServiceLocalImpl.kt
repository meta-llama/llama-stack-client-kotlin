...
class ToolRuntimeServiceLocalImpl constructor(private val clientOptions: LocalClientOptions) :
    ToolRuntimeService {
    private val ragTool: RagToolService by lazy { RagToolServiceLocalImpl(clientOptions) }
